...
Event.create!(name: Faker::App.name,description: "Just an annual birthday",location: "Home",
...
Event.create!(name: "Office meeting",description: "Team dinner",location: "Office",
